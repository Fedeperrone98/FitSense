...
public class FitSenseDBHandler {
    ...
    public static void updateMaxPresenceArea (int area_id, int max_presence){
        ...
        try (Connection smartPoolConnection = makeDBConnection();
             PreparedStatement smartPoolPrepareStat = smartPoolConnection.prepareStatement(updateQueryStatement);
        ) {
    ...
    public static boolean checkAreaExistance(int id){
    ...
    public static Map<Integer, Integer> getLastTemperature(){
        ...
        try (Connection smartPoolConnection = makeDBConnection();
             PreparedStatement smartPoolPrepareStat = smartPoolConnection.prepareStatement(selectQueryStatement1);
             ) {
            // Execute the query
            ResultSet resultSet = smartPoolPrepareStat.executeQuery();
            ...
            while (resultSet.next()){
                ...
                try (Connection smartPoolConnection2 = makeDBConnection();
                     PreparedStatement smartPoolPrepareStat2 = smartPoolConnection2.prepareStatement(selectQueryStatement2);
                     ) {
